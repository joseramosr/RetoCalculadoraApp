...
public class PerformTheMultiplication implements Task {

    private String number1;
    private String number2;

    public PerformTheMultiplication(String number1, String number2) {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ValidateIfTheNumber.isNegative(number1), Click.on(BTN_MULTIPLY),
    ...
    public static Performable ofTheNumbers(String number1, String number2) {
        return instrumented(PerformTheMultiplication.class, number1, number2);
    }
}
