...
public class PerformTheSubtraction implements Task {

    private String number1;
    private String number2;

    public PerformTheSubtraction(String number1, String number2) {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Click.on(BTN_MINUS),
                Click.on(BTN_NUMBER.of(number2)),
                Click.on(BTN_EQUALS));
    }

    public static Performable ofTheNumbers(String number1, String number2) {
        return instrumented(PerformTheSubtraction.class, number1, number2);
    }
}
